...
- **Update #:** 1   |   **Date:** **2025-10-29** (YYYY-MM-DD)
...
- https://github.com/kazuma-naka/404-team-not-found/issues/15
- https://github.com/kazuma-naka/task_manager_prototype
- https://github.com/kazuma-naka/404-team-not-found/pull/34
...
- Create tables with `sqlite3` and set it up in `app.py`
- Implement `Session & Login` and UI
